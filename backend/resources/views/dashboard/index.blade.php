...
@section('content')
    <div class="row">
        <div class="col-xl-3 col-sm-6 mt-2 mb-xl-0 mb-4">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-primary shadow-primary text-center rounded-circle">
                                <i class="icofont-money text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient-danger shadow-danger text-center rounded-circle">
                                <i class="icofont-shopping-cart text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                                <i class="icofont-male text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-dark shadow-warning text-center rounded-circle">
                                <i class="icofont-file-fill text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-success shadow-warning text-center rounded-circle">
                                <i class="icofont-database text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <div class="icon icon-shape bg-primary shadow-warning text-center rounded-circle">
                                <i class="icofont-list text-lg opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
                        ...
                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                            <div class="d-flex align-items-center">
                                <div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center">
                                    <i class="icofont-question text-white opacity-10"></i>
                                </div>
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark text-sm">Event</h6>
                                    <span class="text-xs">information <span class="font-weight-bold">346+
                                            sold</span></span>
                                </div>
                            </div>
